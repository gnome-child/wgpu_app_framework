use super::super::buffer::normalize_for_buffer;
use super::super::buffer::{Buffer, Cursor, Selection, TextPosition};
...
use super::super::view::{Preedit, TextViewState};
...
impl FieldProjection {
    ...
    pub(crate) fn source_position(&self, position: TextPosition) -> TextPosition {
...
impl PreeditProjection {
    pub(crate) fn new(buffer: &Buffer, state: &TextViewState) -> Self {
...
pub(super) fn preedit_replacement_range(buffer: &Buffer, source: &str) -> std::ops::Range<usize> {
...
pub(crate) fn projected_state_for_field(field: &Field, state: TextViewState) -> TextViewState {
