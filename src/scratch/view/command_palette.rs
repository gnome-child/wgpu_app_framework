...
use super::{Node, View};
use crate::scratch::{command, context::Source, interaction, subject, view};

pub(in crate::scratch) struct CommandPalette {
    query: String,
    selected: usize,
    entries: Vec<Entry>,
...
pub(in crate::scratch) struct Entry {
...
impl View {
    pub(in crate::scratch) fn project_command_palette(&mut self, palette: CommandPalette) {
