...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub(in crate::scratch) enum KeyChordKind {
...
impl KeyChord {
    ...
    pub(in crate::scratch) fn kind(self) -> KeyChordKind {
        self.kind
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub(in crate::scratch) struct ParsedKeyChord {
    key: ParsedKey,
...
impl Spec {
    ...
    pub(in crate::scratch) fn key_chord(mut self, shortcut: KeyChord) -> Self {
...
impl ParsedKeyChord {
    ...
    pub(in crate::scratch) fn resolve(
        self,
        platform: keymap::Platform,
    ) -> Option<keymap::ConcreteChord> {
