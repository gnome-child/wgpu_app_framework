...
impl Session {
    ...
    pub(in crate::scratch) fn dismiss_command_palette_for_surface(
        &mut self,
        id: app_window::Id,
        inside_surface: bool,
    ) -> bool {
    ...
    pub(in crate::scratch) fn command_palette_query(&self, id: app_window::Id) -> Option<String> {
    ...
    pub(in crate::scratch) fn command_palette_selected(&self, id: app_window::Id) -> Option<usize> {
        self.window(id)?
            .interaction
            .command_palette()
    ...
    pub(in crate::scratch) fn command_palette_captured_focus(
        &self,
        id: app_window::Id,
    ...
    pub(in crate::scratch) fn reset_command_palette_selection(
        &mut self,
        id: app_window::Id,
    ) -> bool {
        self.window_mut(id)
    ...
    pub(in crate::scratch) fn select_command_palette_next(
        &mut self,
        id: app_window::Id,
        len: usize,
    ) -> bool {
    ...
    pub(in crate::scratch) fn select_command_palette_previous(
        &mut self,
        id: app_window::Id,
        len: usize,
    ) -> bool {
    ...
    pub(in crate::scratch) fn select_command_palette_page_next(
        &mut self,
        id: app_window::Id,
        len: usize,
        page: usize,
    ...
    pub(in crate::scratch) fn select_command_palette_page_previous(
        &mut self,
        id: app_window::Id,
        len: usize,
        page: usize,
    ...
    pub(in crate::scratch) fn select_command_palette_first(
        &mut self,
        id: app_window::Id,
        len: usize,
    ) -> bool {
    ...
    pub(in crate::scratch) fn select_command_palette_last(
        &mut self,
        id: app_window::Id,
        len: usize,
    ) -> bool {
