...
use crate::scratch::{command, state};

const HISTORY_GROUP_COALESCE_WINDOW: Duration = Duration::from_millis(1000);

pub(in crate::scratch::runtime) struct ActiveGroup {
...
impl<M: state::State, E: Send + 'static, V> Runtime<M, E, V> {
    ...
    pub(in crate::scratch::runtime::transaction) fn coalesces_history_group(
        &mut self,
    ...
    pub(in crate::scratch::runtime::transaction) fn clear_history_group(&mut self) {
