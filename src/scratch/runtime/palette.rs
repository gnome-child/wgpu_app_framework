...
impl<M: state::State, E: Send + 'static, V> Runtime<M, E, V> {
    pub(in crate::scratch::runtime) fn command_palette_projection(
        &mut self,
        window: window::Id,
    ...
    pub(in crate::scratch::runtime) fn handle_command_palette_key(
        &mut self,
        window: window::Id,
        key: input::Key,
    ...
    pub(in crate::scratch::runtime) fn activate_command_palette_binding(
        &mut self,
        window: window::Id,
