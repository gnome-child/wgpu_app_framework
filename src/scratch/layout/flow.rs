...
pub(in crate::scratch) struct Constraints {
    min: Size,
    max: Size,
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(in crate::scratch) struct SizeHint {
    min: Size,
    preferred: Size,
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(in crate::scratch) struct Item {
    hint: SizeHint,
    grow: bool,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub(in crate::scratch) struct Row {
    items: Vec<Item>,
    gap: i32,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(in crate::scratch) struct Column {
    items: Vec<Item>,
    gap: i32,
    padding: view::style::Padding,
    align_items: view::style::Align,
...
impl Constraints {
    pub(in crate::scratch) fn new(min: Size, max: Size) -> Self {
    ...
    pub(in crate::scratch) fn max(self) -> Size {
        self.max
    }

    pub(in crate::scratch) fn constrain(self, size: Size) -> Size {
        Size::new(
...
impl SizeHint {
    pub(in crate::scratch) fn new(min: Size, preferred: Size) -> Self {
        let min = min.sanitized();
    ...
    pub(in crate::scratch) fn fixed(size: Size) -> Self {
        Self::new(size, size)
    }

    pub(in crate::scratch) fn min(self) -> Size {
        self.min
    }

    pub(in crate::scratch) fn preferred(self) -> Size {
        self.preferred
    }

    pub(in crate::scratch) fn constrained(self, constraints: Constraints) -> Self {
        Self::new(
...
impl Item {
    pub(in crate::scratch) fn fixed(hint: SizeHint) -> Self {
        Self { hint, grow: false }
    }

    pub(in crate::scratch) fn grow(hint: SizeHint) -> Self {
        Self { hint, grow: true }
    }
}

impl Row {
    pub(in crate::scratch) fn new() -> Self {
        Self {
            items: Vec::new(),
            gap: 0,
    ...
    pub(in crate::scratch) fn gap(mut self, gap: i32) -> Self {
        self.gap = gap.max(0);
        self
    }

    pub(in crate::scratch) fn padding(mut self, padding: view::style::Padding) -> Self {
        self.padding = padding;
        self
    }

    pub(in crate::scratch) fn align_items(mut self, align: view::style::Align) -> Self {
        self.align_items = align;
        self
    }

    pub(in crate::scratch) fn justify_content(mut self, align: view::style::Align) -> Self {
        self.justify_content = align;
        self
    }

    pub(in crate::scratch) fn item(mut self, item: Item) -> Self {
        self.items.push(item);
        self
    }

    pub(in crate::scratch) fn size_hint(&self) -> SizeHint {
        let min_width = self
            .items
            .iter()
    ...
    pub(in crate::scratch) fn layout(&self, rect: Rect) -> Vec<Rect> {
