...
pub(in crate::scratch::layout) fn size_hint(
    node: &view::Node,
...
pub(in crate::scratch::layout) fn intrinsic_height_for_width(
    node: &view::Node,
    width: i32,
    engine: &mut engine::Engine,
    theme: &theme::Theme,
...
pub(in crate::scratch::layout) fn floating_panel_height(
    node: &view::Node,
    theme: &theme::Theme,
) -> i32 {
...
pub(in crate::scratch::layout) fn floating_panel_height_for_width(
    node: &view::Node,
    width: i32,
    engine: &mut engine::Engine,
    theme: &theme::Theme,
...
pub(in crate::scratch::layout) fn floating_panel_max_envelope_height_for_width(
    node: &view::Node,
    width: i32,
    engine: &mut engine::Engine,
    theme: &theme::Theme,
...
pub(in crate::scratch::layout) fn floating_panel_width(
    node: &view::Node,
    engine: &mut engine::Engine,
    theme: &theme::Theme,
) -> i32 {
...
pub(in crate::scratch::layout) fn shortcut_display_width(
...
pub(in crate::scratch::layout) fn shortcut_run_width(
...
pub(in crate::scratch::layout) fn shortcut_run_gap(_theme: &theme::Theme) -> i32 {
    2
}

pub(in crate::scratch::layout) fn shortcut_icon_extent(theme: &theme::Theme) -> i32 {
...
pub(in crate::scratch::layout) fn layout_gap(node: &view::Node, theme: &theme::Theme) -> i32 {
...
pub(in crate::scratch::layout) fn cross_axis_height_for_width(
    node: &view::Node,
    width: i32,
    parent_height: i32,
    engine: &mut engine::Engine,
...
pub(in crate::scratch::layout) fn resolved_height_for_width(
    node: &view::Node,
    width: i32,
    parent_height: i32,
    engine: &mut engine::Engine,
...
pub(in crate::scratch) fn section_header_height(theme: &theme::Theme) -> i32 {
    (section_header_style(theme).size() * 1.25).ceil() as i32 + theme.control().padding.max(0)
}

pub(in crate::scratch::layout) fn section_header_text(label: &str) -> String {
    label.chars().flat_map(char::to_uppercase).collect()
}

pub(in crate::scratch) fn section_header_style(theme: &theme::Theme) -> theme::TypeStyle {
    let caption = theme.typography().caption();
    theme::TypeStyle::new(caption.size(), crate::text::document::Weight::Bold)
}

pub(in crate::scratch) fn shortcut_text_style(theme: &theme::Theme) -> theme::TypeStyle {
    interface_text_style(theme)
}

pub(in crate::scratch) fn interface_text_style(theme: &theme::Theme) -> theme::TypeStyle {
