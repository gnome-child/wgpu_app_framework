...
mod algorithm;
pub(in crate::scratch) mod chrome;
pub(in crate::scratch) mod control;
pub mod engine;
pub(in crate::scratch) mod flow;
pub mod frame;
pub mod hit;
mod measure;
pub mod path;
...
impl Layout {
    ...
    pub(in crate::scratch) fn compose_with_theme_at(
        view: &view::View,
        size: Size,
        engine: &mut engine::Engine,
        theme: &Theme,
    ...
    pub(in crate::scratch) fn compose_composition_with_theme_at(
    ...
    pub(in crate::scratch) fn chrome(&self) -> &[chrome::Chrome] {
        &self.chrome
    }
    ...
    pub(in crate::scratch) fn drag_action_for_target(
        &self,
    ...
    pub(in crate::scratch) fn active_descendant_reveal_offset(
        &self,
        ...
        let descendant = if let Some(selected_index) = selected_index {
            self.frames
                .iter()
                .filter(|frame| {
                    frame.binding_source() == Some(crate::scratch::context::Source::Palette)
...
pub(in crate::scratch) fn section_header_text(label: &str) -> String {
    measure::section_header_text(label)
}

pub(in crate::scratch) fn section_header_style(theme: &Theme) -> crate::scratch::theme::TypeStyle {
    measure::section_header_style(theme)
}

pub(in crate::scratch) fn shortcut_text_style(theme: &Theme) -> crate::scratch::theme::TypeStyle {
    measure::shortcut_text_style(theme)
}

pub(in crate::scratch) fn shortcut_run_gap(theme: &Theme) -> i32 {
    measure::shortcut_run_gap(theme)
}

pub(in crate::scratch) fn interface_text_style(theme: &Theme) -> crate::scratch::theme::TypeStyle {
