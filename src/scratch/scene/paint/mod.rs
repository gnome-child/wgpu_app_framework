...
fn paint_scrollbar(
    ...
    let visible = match theme_scrollbar.metrics.policy {
        crate::scratch::theme::ScrollbarPolicy::GutterAlways => 1.0,
        crate::scratch::theme::ScrollbarPolicy::OverlayAuto => visual.opacity(),
    };
    if visible <= 0.0 {
        return;
    }
    ...
    let base_thickness = match theme_scrollbar.metrics.policy {
        crate::scratch::theme::ScrollbarPolicy::GutterAlways => {
            theme_scrollbar.metrics.thickness.max(1)
        }
        crate::scratch::theme::ScrollbarPolicy::OverlayAuto => {
...
fn scene_text_style(style: crate::scratch::theme::TypeStyle) -> TextStyle {
