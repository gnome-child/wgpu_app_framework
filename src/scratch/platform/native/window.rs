...
use crate::{geometry::area, render};
use std::sync::Arc;
use winit::dpi::LogicalSize;
use winit::{event_loop::ActiveEventLoop, window::WindowAttributes};

pub(in crate::scratch::platform::native) type Handle = Arc<winit::window::Window>;

pub(in crate::scratch::platform::native) struct Window {
    handle: Handle,
    canvas: render::Canvas,
}

pub(in crate::scratch::platform::native) struct Options {
    pub title: String,
    pub inner_size: InitialSize,
}

pub(in crate::scratch::platform::native) enum InitialSize {
