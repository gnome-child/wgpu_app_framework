...
impl Native {
    ...
    pub(in crate::scratch::platform::native) fn ensure_renderer(
        &mut self,
    ...
    pub(in crate::scratch::platform::native) fn create_native_window(
        &mut self,
    ...
    pub(in crate::scratch::platform::native) fn clear_window(
        &mut self,
    ...
    pub(in crate::scratch::platform::native) fn present_native(
        &mut self,
