...
impl Composition {
    ...
    pub(in crate::scratch) fn project_transient_state(
        &mut self,
    ...
    #[cfg(test)]
    pub(in crate::scratch) fn changes(&self) -> &Changes {
        &self.changes
    }
    ...
    pub(in crate::scratch) fn next_focus(
        &self,
    ...
    pub(in crate::scratch) fn focus_action(&self, focus: &session::Focus) -> Option<view::Action> {
        self.view.focus_action_retained(focus, &self.tree)
    }

    pub(in crate::scratch) fn subject_path_for_focus(
        &self,
        focus: Option<session::Focus>,
    ) -> subject::Path {
        focus
    ...
    pub(in crate::scratch) fn node_is_self_or_descendant_of_element(
        &self,
        node_id: NodeId,
